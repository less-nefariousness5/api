...
---@field public min_damage number
---@field public max_damage number
---@field public pos_buff integer
---@field public neg_buff integer
...
---@field public get_effective_level fun(self: game_object): number
---Returns the gold amount of the game object (in copper).
---@field public get_gold fun(self: game_object): number
...
---@field public get_combat_reach fun(self: game_object): number
...
---@field public is_quest_unit fun(self: game_object): boolean
...
---@field public has_skin fun(self: game_object): boolean
...
---@field public get_empower_max_stage fun(self: game_object): number
...
---@field public get_unit_ranged_damage fun(self: game_object): unit_ranged_damage_data
